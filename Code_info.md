The tool used for obtaining the core genome alignment from the list of raw genomes is progressiveMauve. This can be downloaded [here](http://darlinglab.org/mauve/download.html)
